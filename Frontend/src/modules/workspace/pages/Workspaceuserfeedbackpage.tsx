...
const WorkspaceUserFeedbackPage = () => {
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <button
            onClick={() => navigate(roleConfig.projectRoute(Number(projectId)))}
          ...
          {roleConfig.canCreateFeedback && (
            <Button
              ...
              onClick={() =>
                navigate(
                  roleConfig.createFeedbackRoute(Number(projectId), Number(userId))
                )
              }
            >
              Submit Feedback
        ...
        {isLoading ? (
          ...
          <>
            {/* Stats Bar — matches TLUserFeedbackWorkspacePage exactly */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:divide-x divide-slate-100">
                ...
                <div className="flex items-center gap-4 md:pl-6">
                  ...
                  <div>
                    ...
                    <p className="text-[28px] font-bold text-slate-900 leading-none mt-1">
                      {data.user.openFeedbackCount + data.user.resolvedFeedbackCount}
                    </p>
                  </div>
                </div>
              </div>
            ...
            {data.feedbacks.length === 0 ? (
              <div className="bg-white border border-slate-200 rounded-2xl p-12 text-center">
                ...
                <h2 className="text-[18px] font-semibold text-slate-900">No Feedbacks Found</h2>
              ...
              <div className="space-y-4">
                {data.feedbacks.map((feedback) => (
                  <div
                    key={feedback.id}
                    onClick={() =>
                      navigate(roleConfig.feedbackDetailsRoute(feedback.id))
                    }
...
export default WorkspaceUserFeedbackPage;