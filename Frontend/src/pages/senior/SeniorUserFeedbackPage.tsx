    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          <button
            onClick={() => navigate(`/senior/projects/${projectId}`)}
          ...
          <Button
            variant="primary"
            onClick={() =>
              navigate(`/senior/projects/${projectId}/users/${userId}/create-feedback`)
            }
          >
            Submit Feedback
          </Button>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex items-center gap-3 mb-6">
              <p className="text-[11px] font-semibold uppercase tracking-widest text-slate-400">Filter:</p>
...
export default SeniorUserFeedbackPage;
