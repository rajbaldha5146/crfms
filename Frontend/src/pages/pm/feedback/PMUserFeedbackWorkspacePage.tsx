...
const PMUserFeedbackWorkspacePage = () => {
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <Button
            ...
            onClick={() =>
              navigate(
                `/pm-projects/${projectId}/users/${userId}/create-feedback`
              )
            }
          >
            Submit Feedback
        ...
        {isPageLoading ? (
          ...
          <>
            ...
            {/* Feedbacks Grid with Loading Overlay */}
            <div className="relative">
              {isFeedbackLoading && (
                <div className="absolute inset-0 bg-white/50 backdrop-blur-[0.5px] z-10 flex items-center justify-center rounded-2xl">
                  <div className="flex flex-col items-center gap-2">
                    <div className="spinner-gradient scale-75" />
...
export default PMUserFeedbackWorkspacePage;