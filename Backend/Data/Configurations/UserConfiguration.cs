...
public class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(u => u.Experience).HasMaxLength(50);
        builder.Property(u => u.MobileNumber).HasMaxLength(20);

        builder.Property(u => u.Department).HasConversion<string>();
        builder.Property(u => u.Gender).HasConversion<string>();
        builder.Property(u => u.Status).HasConversion<string>().HasDefaultValue(UserStatus.Active);
